...
namespace _Script.Action
{
    ...
    public class AddCount : ActionBase
    {
        ...
        {
            _count = (CountState)DataModel.Decode<CountState>((Bencodex.Types.Dictionary)plainValue);
        }
        ...
        public override IAccountStateDelta Execute(IActionContext ctx)
        {
            ...
            var nextCount = currentCount + _count.count;
